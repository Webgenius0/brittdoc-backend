@extends('backend.app')
@section('title', 'Subscription planning Page')
...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">Subscription planning List</h3>
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Subscription planning Page </span>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Subscription planning List</span>
                    </li>
                </ol>
            </nav>
        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('planning.status', ':id') }}';
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('planning.destroy', ':id') }}';
